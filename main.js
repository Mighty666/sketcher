...
randomnum = Math.floor((Math.random()*quick_draw_data_set.length)+1);
random = quick_draw_data_set[randomnum];
document.getElementById("draw").innerHTML = "Draw a "+random;
timernum = 0;
timercheck = "";
realsketch = "";
correct = "";
...
function check_sketch(){
    timernum++;
    document.getElementById("timer").innerHTML = "Timer: "+timernum;
    if(timernum>500){
        document.getElementById("sketch1").innerHTML = "Your Sketch: ";
        document.getElementById("confidence1").innerHTML = "Confidence: ";
        timernum = 0;
        timercheck = "done";
    }
    if(timercheck == "done" || correct == "correct"){
        timercheck = "";
        correct = "";
        updateCanvas();
        document.getElementById("sketch1").innerHTML = "Your Sketch: ";
...
function updateCanvas(){
    ...
    random = Quick_draw_data_set[randomnum];
    sketch = random;
    document.getElementById("draw").innerHTML = "Draw a "+sketch;
}
...
function gotResults(error,results){
    ...
    console.log(results);
    realsketch = results[0].label;
    document.getElementById("sketch1").innerHTML="Your Sketch : "+results[0].label;
